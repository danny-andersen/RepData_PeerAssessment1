...
There are a number of missing values in the dataset (`r numNas`), which is equivalent to `r format(naPercent, nsmall=1, scientific = F)` % of the total dataset. One strategy is to replace  missing values with the average step count for the particular interval that is missing. 
