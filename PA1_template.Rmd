...
A histogram of the daily steps for this new dataset is shown below

```{r}
synthByDay <- group_by(synthed,date) %>%
    summarise(dailySteps = sum(steps)) %>%
    filter(dailySteps != 0)
qplot(dailySteps, data=synthByDay, geom="histogram",  xlab = "Number of steps per day", ylab="How many days", main = "Histogram of daily steps")
```
